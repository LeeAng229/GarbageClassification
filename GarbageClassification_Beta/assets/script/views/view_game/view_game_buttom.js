...
cc.Class({
    ...
    countDown(){
        ...
        //获取label节点
        this.node.getChildByName('view_countDown').getComponent(cc.Label).string = this.countDownNumArr[this.index];
